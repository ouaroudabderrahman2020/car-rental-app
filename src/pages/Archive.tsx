          ...
          <div className="max-w-[1440px] mx-auto px-margin">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 pt-10">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-2xl font-bold text-ink uppercase tracking-tight">{t('archive.overview', 'Archive Overview')}</h2>
              </div>
            ...
            <div className="flex items-center gap-4 mb-8">
              <h2 className="text-2xl font-bold text-ink">{t('reservations.history')}</h2>
              <div className="h-[1px] flex-grow bg-ink/10"></div>
              <span className="px-3 py-1 bg-ink text-white text-xs font-bold uppercase tracking-widest">{archiveData.length} {t('reservations.entries')}</span>
            </div>
                ...
                <table className="w-full text-left border-collapse responsive-table">
                  <thead>
                    <tr className="bg-[#1E293B] text-white font-sans text-xs uppercase tracking-[0.1em] border-b border-ink/20">
                      <th className="py-4 px-6 border-e border-white/10 font-extrabold text-center">{t('archive.table.id')}</th>
                      <th className="py-4 px-6 border-e border-white/10 font-extrabold text-center">{t('archive.table.client')}</th>
                      ...
                      <th className="py-4 px-6 font-extrabold text-center">{t('archive.table.total')}</th>
                    </tr>
                  </thead>
