    ...
    <div className={`flex flex-col w-full relative mt-2 ${className}`} style={style}>
      ...
      {isSelect ? (
        <select
          ...
          disabled={disabled}
          className={`
            p-[11px_10px] text-[0.75rem] border-[1px] border-black rounded-[5px] bg-white font-bold uppercase
            focus:outline-none focus:border-2 transition-all
            ${error ? 'ring-2 ring-red-500 border-red-500' : ''}
            disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-black
          `}
        >
          {children}
        </select>
        ...
        <textarea
          ...
          disabled={disabled}
          className={`
            p-[11px_10px] text-[0.75rem] border-[1px] border-black rounded-[5px] bg-white font-bold min-h-[100px]
            focus:outline-none focus:border-2 transition-all
            ${error ? 'ring-2 ring-red-500 border-red-500' : ''}
            disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-black
          `}
